            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <img src="<?= base_url()?>assets/images/mobil/<?= $mobil['foto_mobil'];?>" alt="" style="width:100%; height:400px" >
                            </div>
                            <div class="col-md-6">
                            ...
                            <tr>
                                ...
                                <?php 
                                    ...
                                    ?>
                                    <a href="<?= base_url()?>customer/dashboard" class="btn btn-dark mt-auto">Kembali</a>
                                </td>
                            </tr>
                        </table>
                            </div>
